    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      {grouped.map(({ neighborhood, stores }) => (
        <section key={neighborhood} className="mb-10">
          <h2 className="mb-4 border-b border-amber-200 pb-2 text-xl font-semibold text-amber-800">
            {neighborhood}
          </h2>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {stores.map((store) => (
              ...
              >
                <h3 className="mb-1 text-lg font-semibold text-gray-900 group-hover:text-amber-700">
                  {store.name}
                </h3>
